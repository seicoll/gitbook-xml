...
On **_tipus vinyeta_** pot ser: `circle`, `disc`, `square` o `none`.
...
Mitjançant l'atribut `src` (**_source_**), especifiquem el lloc (URL) on es troba la imatge.
...
- Antigament els **_layouts_** una mica complexes es feien o bé amb taules o bé amb frames. Les dues coses estan en desús avui en dia.
